...
const registerUser = asyncHandler(async (req, res) => {
  // registerUser() creates a new user, generates an email verification token, stores it,
  // sends it to the user's email, and finally returns a success response.
...
const loginUser = asyncHandler(async (req, res) => {
  // User enters credentials → Server verifies them → Generates tokens → Logs the user in.
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // await user.save();  // This is already done in generateAccessAndRefreshTokens function
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  // console.log("Inside changeCurrentPassword");
